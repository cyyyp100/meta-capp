...
// context-menu.tsx — Menu du clic droit (Radix ContextMenu), habillé comme
// dropdown-menu.tsx : mêmes classes, même portail, même animation. Un menu
// contextuel n'a pas de déclencheur visible : c'est précisément ce qu'on veut
// pour la suppression d'un document, qui ne doit porter aucune icône.
